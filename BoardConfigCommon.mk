...
-include device/xiaomi/qcom-common/BoardConfigCommon.mk

LOCAL_PATH := device/xiaomi/msm8226-common

# this will lead to compile v8 module faile
#TARGET_SPECIFIC_HEADER_PATH += $(LOCAL_PATH)/include

# Inline kernel building
#BOARD_KERNEL_SEPARATED_DT := true
#BOARD_CUSTOM_BOOTIMG_MK := device/xiaomi/msm8226-common/mkbootimg.mk
